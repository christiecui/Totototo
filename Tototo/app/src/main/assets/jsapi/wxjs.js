...
var _WXJS = (function() {
  ...
  $.fn = {
    ...
    find: function(selector){
      ...
      else result = this.map(function(){ return _WXJS.qsa(this, selector) })
      return $(result)
    },
  ...
  adjacencyOperators.forEach(function(key, operator) {
    $.fn[key] = function(){
      ...
      var nodes = $.map(arguments, function(n){ return isObject(n) ? n : _WXJS.fragment(n) })
...
;(function($){
  var $$ = $._WXJS.qsa, handlers = {}, _zid = 1, specialEvents={}
...
var vsprintf = function(fmt, argv) {
  ...
  return sprintf.apply(null, argv);
    ...
    function _createQueueReadyIframe(doc) {
		...
		_setResultIframe.src = 'cuiqi://private/setresult/';
	...
	function _continueSetResult() {
		...
		if (result === undefined) {
			...
			window.alert("setResultIframe src");
			_setResultIframe.src = 'weixin://private/setresult/' + result;
		}
	}

    function _isIn3rdApiList(event) {
    	var r = _runOn3rdApiList.some(function(x){return x === event;});
