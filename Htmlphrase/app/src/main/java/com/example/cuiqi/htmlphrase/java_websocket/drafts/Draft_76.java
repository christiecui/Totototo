package com.example.cuiqi.htmlphrase.java_websocket.drafts;

import com.example.cuiqi.htmlphrase.java_websocket.WebSocket;
import com.example.cuiqi.htmlphrase.java_websocket.exceptions.IncompleteHandshakeException;
import com.example.cuiqi.htmlphrase.java_websocket.exceptions.InvalidHandshakeException;
...
import com.example.cuiqi.htmlphrase.java_websocket.exceptions.InvalidFrameException;
import com.example.cuiqi.htmlphrase.java_websocket.exceptions.InvalidHandshakeException;
import com.example.cuiqi.htmlphrase.java_websocket.exceptions.LimitExedeedException;
import com.example.cuiqi.htmlphrase.java_websocket.exceptions.NotSendableException;
import com.example.cuiqi.htmlphrase.java_websocket.framing.CloseFrame;
import com.example.cuiqi.htmlphrase.java_websocket.framing.CloseFrameBuilder;
import com.example.cuiqi.htmlphrase.java_websocket.framing.FrameBuilder;
import com.example.cuiqi.htmlphrase.java_websocket.framing.Framedata;
import com.example.cuiqi.htmlphrase.java_websocket.framing.FramedataImpl1;
import com.example.cuiqi.htmlphrase.java_websocket.handshake.ClientHandshake;
import com.example.cuiqi.htmlphrase.java_websocket.handshake.ClientHandshakeBuilder;
import com.example.cuiqi.htmlphrase.java_websocket.handshake.HandshakeBuilder;
import com.example.cuiqi.htmlphrase.java_websocket.handshake.Handshakedata;
import com.example.cuiqi.htmlphrase.java_websocket.handshake.ServerHandshake;
import com.example.cuiqi.htmlphrase.java_websocket.handshake.ServerHandshakeBuilder;
import com.example.cuiqi.htmlphrase.java_websocket.util.Charsetfunctions;
...
public class Draft_76 extends Draft_75 {
	...
	public Handshakedata translateHandshake(ByteBuffer buf ) throws InvalidHandshakeException {
		...
		if( ( bui.hasFieldValue( "Sec-WebSocket-Key1" ) || role == WebSocket.Role.CLIENT ) && !bui.hasFieldValue( "Sec-WebSocket-Version" ) ) {
			byte[] key3 = new byte[ role == WebSocket.Role.SERVER ? 8 : 16 ];
			try {
				buf.get( key3 );
