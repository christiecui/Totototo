...
import com.example.cuiqi.htmlphrase.java_websocket.handshake.HandshakeImpl1Client;
import com.example.cuiqi.htmlphrase.java_websocket.handshake.HandshakeImpl1Server;
...
public abstract class Draft {
	...
	public List<Framedata> continuousFrame(Framedata.Opcode op, ByteBuffer buffer, boolean fin ) {
		if( op != Framedata.Opcode.BINARY && op != Framedata.Opcode.TEXT && op != Framedata.Opcode.TEXT ) {
			throw new IllegalArgumentException( "Only Opcode.BINARY or  Opcode.TEXT are allowed" );
		}

		if( continuousFrameType != null ) {
			continuousFrameType = Framedata.Opcode.CONTINUOUS;
		} else {
